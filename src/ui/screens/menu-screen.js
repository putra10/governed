    ...
    overlay.innerHTML = `
      <div class="modal-box">
        ...
        <div class="modal-body">
          ...
          <p><strong>ADVISORS.</strong> Each has trust and a hidden agenda (at 80, they betray you). They argue their advice in chat with reasons — and a restless advisor's pick may be designed to hurt you, so watch the agenda bar. Trust is <strong>earned, not farmed</strong>: take the option an advisor recommends in their domain and they warm to you (overrule them and it erodes — harder each time in a row); fund their ministry when they ask; or deepen things in the back channel (with diminishing returns). <strong>Chatting and consulting are just talk</strong> — they cost nothing and grant no trust. Ignore advice and pay for it, and a smug "I told you so" lands in your messages the next morning — red badge and all.</p>
